*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_PIPO_LPTYP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_PIPO_LPTYP      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_PIPO_LPTYP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_PIPO_LPTYP_EXTRACT
TOTAL = ZMV_PIPO_LPTYP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_PIPO_LPTYP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_PIPO_LPTYP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PIPO_LPTYP_EXTRACT
TOTAL = ZMV_PIPO_LPTYP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_PIPO_LPTYP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_PIPO_LPTYP'
...
TOTAL = ZMV_PIPO_LPTYP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_PIPO_LPTYP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_PIPO_LPTYP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_PIPO_LPTYP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_PIPO_LPTYP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_PIPO_LPTYP_EXTRACT
TOTAL = ZMV_PIPO_LPTYP_TOTAL
