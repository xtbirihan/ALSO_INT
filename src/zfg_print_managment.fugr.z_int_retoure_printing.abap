FUNCTION z_int_retoure_printing.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"     REFERENCE(FOOTER_DETAILS) TYPE  /SCWM/S_SP_A_HEAD_TEXT
*"         OPTIONAL
*"     REFERENCE(HIER_SORT) TYPE  /SCWM/T_DLV_HIER_SORT_PRINT
*"         OPTIONAL
*"  EXPORTING
...
*"--------------------------------------------------------------------
  ...
  DATA(lo_delilvery_printing) = NEW zcl_int_retoure_printing( iv_form             = zcl_int_print_management=>mv_form
